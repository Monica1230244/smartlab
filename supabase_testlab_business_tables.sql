...
declare
  ...
  pairs text[][] := array[
    ...
    array['satisfactionClients','testlab_satisfaction_clients'],
    ...
    array['gouvernance','testlab_gouvernance'],
    array['demandesPrestations','testlab_demandes_prestations'],
    array['missionsTerrain','testlab_missions_terrain'],
    array['planningProjets','testlab_planning_projets'],
    array['competencesFormations','testlab_competences_formations'],
    array['metrologieAvancee','testlab_metrologie_avancee'],
    array['financesAvancees','testlab_finances_avancees'],
    array['objectifsQualite','testlab_objectifs_qualite'],
    array['moteursSysteme','testlab_moteurs_systeme'],
